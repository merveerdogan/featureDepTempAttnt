...
// Wait for jsPsych to be available before registering plugin


var instructionPractice = (function (jspsych) {
    /*===============================================================
                         PARAMETERS
    ===============================================================*/
    const info = {
        ...
        version: "1.0.0",
        description: "Instruction practice plugin for the feature dependent temporal attention experiment",
        parameters: {
            /*===============================
    ...
    instructionPractice.info = info;

    return instructionPractice;
})(jsPsychModule);
